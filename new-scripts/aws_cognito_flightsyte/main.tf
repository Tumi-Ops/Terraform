resource "aws_cognito_user_pool" "FlightSiteUserPool" {
...
resource "aws_cognito_user_pool_domain" "main" {
  domain       = "flightsyte"
  user_pool_id = aws_cognito_user_pool.FlightSiteUserPool.id
  managed_login_version = 2
}

resource "aws_cognito_user_pool_client" "FlightSiteClient" {
  name                                 = "FlightSite"
  user_pool_id                         = aws_cognito_user_pool.FlightSiteUserPool.id
...
resource "aws_cognito_managed_login_branding" "example" {
  client_id    = aws_cognito_user_pool_client.FlightSiteClient.id
  user_pool_id = aws_cognito_user_pool.FlightSiteUserPool.id
  asset {
